...
void main() {
  ...
  */
  /*
        ...
        const name = ‘Dhiren ';
        message += name; // 'Hello my name is Dhiren'
 
        final message = StringBuffer();
        message.write('Hello');
        message.write(' my name is ');
        message.write('Dhiren');
        message.toString(); // "Hello my name is Dhiren"
  ...
  */
  /*
        ...
        const name = "Dhiren";
        const intro = "Hello , My name is $name"; //Hello my name is Dhiren
